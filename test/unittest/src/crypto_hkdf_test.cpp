...
namespace {
class CryptoHkdfTest : public testing::TestWithParam<std::string> {
public:
...
std::vector<std::string> hkdfMdAlgoParams = {
    "SHA1",
    "SHA224",
    "SHA256",
    "SHA384",
...
INSTANTIATE_TEST_SUITE_P(CryptoHkdfTestParam, CryptoHkdfTest,
    ::testing::ValuesIn(hkdfMdAlgoParams),
...
HWTEST_P(CryptoHkdfTest, CryptoHkdfAlgoTest, TestSize.Level0)
{
    std::string kdfName = "HKDF";
